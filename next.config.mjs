  ...
  async rewrites() {
    return [
      ...
      },
      {
        source: "/users/:path*",
        destination:
          "https://bootcamp-api.codeit.kr/api/2-4/the-julge/users/:path*",
      },
      {
        source: "/shops/:path*",
        destination:
          "https://bootcamp-api.codeit.kr/api/2-4/the-julge/shops/:path*",
      },
      {
        source: "/notices/:path*",
        destination:
          "https://bootcamp-api.codeit.kr/api/2-4/the-julge/notices/:path*",
      },
      {
        source: "/images",
